...
export const FinalSetTiebreakInitialization: Story = {
  render: () => {
    ...
    description.innerHTML = 'This test verifies that when toggling "Final set" ON with a format that has tiebreak on the main set (SET3-S:6/TB7), the final set should also default to having a tiebreak.<br><br><strong>Expected:</strong> SET3-S:6/TB7-F:6/TB7<br><strong>Bug (fixed):</strong> SET3-S:6/TB7-F:6';
...
export const FinalSetNoTiebreakWhenMainHasNone: Story = {
  render: () => {
    ...
    const description = document.createElement('p');
    description.innerHTML = 'When main set has NO tiebreak, final set should also default to NO tiebreak.<br><br><strong>Expected:</strong> SET3-S:6-F:6';
    description.style.color = '#555';
    description.style.marginBottom = '1.5em';
...
export const PreserveExistingFinalSetTiebreak: Story = {
  render: () => {
    ...
    const description = document.createElement('p');
    description.innerHTML = 'When opening with SET3-S:6/TB7-F:6 (main has tiebreak, final does NOT), should preserve the explicit choice.<br><br><strong>Expected:</strong> Final set tiebreak checkbox should be UNCHECKED';
    description.style.color = '#555';
    description.style.marginBottom = '1.5em';
