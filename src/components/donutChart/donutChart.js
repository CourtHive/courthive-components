// TODO: Convert to d3 version 7
// This chart was migrated from TMX where it used d3 v5.16.0.
// The courthive-components project uses d3 v7.9.0.
// d3 v7 is ESM-only and some APIs have changed (e.g. selection.on callback signatures
// now receive (event, datum) instead of (datum, index, nodes)).
// Review and update all d3 calls accordingly.
